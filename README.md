...
### 🧠 [Google AI Edge Face Scanner](https://github.com/Ashar-Naeem/Face-Detecter)

Browser-based face detection & recognition using Google AI Edge (MediaPipe) and face-api.js — runs 100% client-side, no server or data upload needed.

![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black)
![Stars](https://img.shields.io/github/stars/Ashar-Naeem/Face-Detecter?style=flat-square&color=yellow)
...
### ⚡ [AI Energy Optimization](https://github.com/Ashar-Naeem/Energy-Optimization-AI)

Simulates and optimizes energy usage for a factory using an Isolation Forest anomaly detector + Random Forest load forecaster — ~20% simulated energy savings.

![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white)
![Stars](https://img.shields.io/github/stars/Ashar-Naeem/Energy-Optimization-AI?style=flat-square&color=yellow)
